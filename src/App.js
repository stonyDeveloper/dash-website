          ...
          <Route
            ...
            element={
              ...
              >
                ...
                <div className="hero relative flex flex-col justify-between items-center md:grid md:grid-cols-[1.5fr_1fr] md:px-[49px] md:gap-[30px] mt-[50px]">
            ...
            md:text-left max-w-[325px] mx-auto lg:max-w-[100%]"
                      ...
                      <div className="text-center mt-[30px] md:text-left max-w-[325px] mx-auto lg:max-w-[100%]">
                        ...
                        {readLess3 && (<p className="font-[400] text-[20px] leading-[25.2px] px-[4px] mt-[9px] lg:w-[520px] lg:text-[24px] lg:leading-[30.24px]">
                          ...
                          sender is paying or the recipient is paying. Our
                          product allows you to feel safe and secured not just
